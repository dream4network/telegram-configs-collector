...
url = 'https://raw.githubusercontent.com/dream4network/telegram-proxies-collector/main/telegram channels.json'
...
for url_link in subscription_links:
    try:
        ...
        if 'dream4network' not in url_link:
            raw_array_links_content.append((url_link, links_content))
        elif 'dream4network' in url_link and 'channels' in url_link:
